...
| **SQuRo_Tunnel** 钻洞/越障（参考表路线） | `Mjlab-SQuRo-Tunnel` | Phase0 参考层已迁移，一阶段训练中 |
| **SQuRo_Hole** 钻洞/越障（虚拟碰撞路线） | `Mjlab-SQuRo-Hole` | 旧版在 mjlab 1.5 上完整恢复，待训练验证 |
...
| `docs/SQuRo_Hole_技术细节.md` | 钻洞虚拟碰撞版手册（6D 命令与位移位置表、4 段课程、body_contact 软限高） |
